...
## Low-Level Verification Methods

For specific use cases, you can use the underlying verification methods directly:

### Schnorr Verification (Deprecated)
...
## EIP-712 Style Typed Data

For structured data signing (prevents signature reuse across contracts):
