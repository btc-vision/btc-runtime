...
If you're coming from Ethereum/Solidity development, check out the [Solidity Comparison](./getting-started/first-contract.md#solidity-comparison) section in the First Contract guide.
